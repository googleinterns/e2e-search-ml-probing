...
const CLIENT_ID =
	"994292200466-n6us8ptgeda5u5579sgd3k7svibeh5ag.apps.googleusercontent.com"
...
var server_url =
	process.env.NODE_ENV === "production"
		? "https://youtube.sebastienbiollo.com"
		: "http://localhost:9000"
						...
						<List
							...
							<ListItem
								...
								onClick={() => {
									this.setState({
										startGraphs: true,
										actionGraph:
											"Searching a random uploaded video",
									})
							...
							<Collapse
								...
								<List component="div" disablePadding>
									{this.state.myVideos &&
										this.state.myVideos.length > 0 &&
										this.state.myVideos.map((item, idx) => {
											var videoId =
															...
															onClick={() => {
																if (
																	...
																	return this.setState(
																		{
																			helperTextListItem:
																				"Please select an option for privacy status",
																		}
																	)
																}
																if (
